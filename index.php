                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="#">Music Library</a>
                                                <ul class="dropdown">
                                                    <input type="search">
                                                    <li><a href="#"></a></li>
                                                    <li><a href="#">Hip pop</a></li>
                                                    <li><a href="#">Afro beats</a></li>
                                                    <li><a href="#">Country Music</a></li>
                                                            <li><a href="#">Fantacy</a></li>
                                                            <li><a href="#">African tones</a></li>
                                                            <li><a href="#">Accapella</a></li>
                                                            <li><a href="#">Jingle sounds</a></li>
                                                            <input type="search">
                                                </ul>
                                        </ul>
                                ...
                                <div class="login-register-cart-button d-flex align-items-center">
                                    ...
                                    <!-- Cart Button -->
                                    <div class="cart-btn">
                                        <p><span class="icon-shopping-cart"></span> <span class="quantity">5</span></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Nav End -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Trending albums</h6>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="300ms">Adonai Music <span>Adonai Music</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Discover <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading style-2">
                        <p>See what’s new</p>
                        <h2 id="auto-write">Latest Albums</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9">
                    <div class="ablums-text text-center mb-70">
                        <p>Discover these latest albums and more on AdonaiSounds, where you can explore a wide range of music from talented artists across various genres. Whether you're seeking relaxation, inspiration, or simply a new musical adventure, AdonaiSounds has something to offer every music enthusiast. Stay tuned for more exciting releases and let the power of music elevate your senses.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow " data-wow-delay="100ms">
                        <div class="album-thumb">
                            ...
                            <!-- Play Icon -->
                            <div class="play-icon">
                                <a href="https://form.jotform.com/emmanueljohnapeh/paypal-pro-payment-form" class="buy-music"><span class="icon-play-button"></span></a>
                            </div>
                        </div>
                        <div class="album-info">
                            <a href="#">
            ...
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-12 col-md-6">
                  <div class="cont d-flex flex-wrap align-items-center">
                     <a href="index.html" ><img src="img/core-img/favicon.ico" alt="" style="height: 40px;"></a>
                    <h2 class="logo text-white px-2  d-flex" style= "font-family:cursive; font-size: 20px;"><span style="color: rgb(161, 9, 154)
