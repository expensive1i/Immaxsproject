        ...
        var h2Element = document.getElementById('auto-write');
        var originalText = h2Element.innerHTML;
        ...
        function autoWrite() {
            ...
            function type() {
                h2Element.innerHTML = text.slice(0, index);
                index++;
                if (index <= text.length) {
                    setTimeout(type, delay);
                } else {
                    setTimeout(erase, delay * 3); // Delay before erasing the text
                }
            }
            ...
            function erase() {
                ...
                if (index >= 0) {
                    ...
                    setTimeout(autoWrite, delay * 2); // Delay before starting again
                }
            }
